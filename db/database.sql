...
CREATE TABLE reviewers (
  ...
  country ENUM('United States','Canada','Mexico') NULL,
  languages JSON NULL,
...
('Alice', 'Ng',  'alice@test.com', '$2b$12$ii3h2LgQw.hA7HFFF.WUMedz3YKaNQKCtfpm.Y1E9NIlX0Q68bOAq', '4085551111', 'Love tacos and brunch.', 'female', NULL, 'San Jose', 'CA', 'United States', JSON_ARRAY('English')),
-- password for Bob: password2
('Bob',   'Kim', 'bob@test.com',   '$2b$12$ZZWy3ZiMwxkwcI4.Ob4.vuEaFPyzpjTijqXD5KRK5LXIE.UxhG/FG', '4155552222', 'Sushi enthusiast.',     'male',   NULL, 'San Francisco', 'CA', 'United States', JSON_ARRAY('English','Korean')),
-- password for Cara: password3
('Cara',  'Lo',  'cara@test.com',  '$2b$12$CI5GTVy3kIECzdouIvUhwup.QOFBmtu/zVdS3mWz5tlC5FSvwISF.', NULL,         'Coffee + pastries.',    NULL,     NULL, 'Oakland', 'CA', 'United States', JSON_ARRAY('English','Spanish'));
...
VALUES
('Taco Town', 'Mexican', 'Street-style tacos and aguas frescas.', '123 Main St', 'San Jose', 'CA', 'United States',
 '408-555-9000', '11am-9pm', JSON_ARRAY('https://pics.example/taco1.jpg'), '$', JSON_ARRAY('tacos','outdoor seating','wifi'),
 'unclaimed', NULL, 1, NULL),

('Sushi Star', 'Japanese', 'Omakase and nigiri specials.', '9 Market St', 'San Francisco', 'CA', 'United States',
 '415-555-9001', '5pm-10pm', JSON_ARRAY('https://pics.example/sushi1.jpg'), '$$$', JSON_ARRAY('sushi','date night'),
 'claimed', 2, NULL, 2),

('Curry Corner', 'Indian', 'Comfort curry and naan.', '55 Santa Clara St', 'San Jose', 'CA', 'United States',
 '408-555-9002', '11am-10pm', JSON_ARRAY('https://pics.example/curry1.jpg'), '$$', JSON_ARRAY('curry','family friendly'),
 'claimed', 1, 3, NULL),

('Cafe Bloom', 'Cafe', 'Espresso, matcha, and pastries.', '700 Broadway', 'Oakland', 'CA', 'United States',
